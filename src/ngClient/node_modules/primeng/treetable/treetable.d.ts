 ...
 * @group Components
 */
export declare class TreeTable extends BaseComponent implements AfterContentInit, OnInit, OnDestroy, BlockableUI, OnChanges {
...
export declare class TreeTableCellEditor extends BaseComponent implements AfterContentInit {
    tt: TreeTable;
...
export declare class TreeTableToggler extends BaseComponent {
    tt: TreeTable;
    rowNode: any;
    constructor(tt: TreeTable);

...
export declare class TableRadioButton implements OnInit, OnDestroy {
    dt: Table;
    cd: ChangeDetectorRef;
    value: any;
...
export declare class TableCheckbox implements OnInit, OnDestroy {
    dt: Table;
    tableService: TableService;
    cd: ChangeDetectorRef;
    value: any;
...
export declare class TableHeaderCheckbox implements OnInit, OnDestroy {
    dt: Table;
    tableService: TableService;
    cd: ChangeDetectorRef;
    readonly disabled: import("@angular/core").InputSignalWithTransform<boolean, unknown>;

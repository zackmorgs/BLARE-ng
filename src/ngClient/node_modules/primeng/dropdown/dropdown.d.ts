...
import { FilterService, OverlayOptions, PrimeTemplate, ScrollerOptions, SelectItem } from 'primeng/api';
...
import * as i8 from "primeng/icons";
...
export declare class DropdownItem extends BaseComponent {
    id: string | undefined;
 ...
 * @group Components
 */
export declare class Dropdown extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    zone: NgZone;
    ...
    isEmpty(): boolean;
    onEditableInput(event: any): void;
    /**
     * Displays the panel.
     * @group Method
     */
    ...
    onKeyDown(event: any, search?: boolean): void;
...
export declare class DropdownModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DropdownModule, [typeof Dropdown, typeof DropdownItem], [typeof i1.CommonModule, typeof i2.OverlayModule, typeof i3.SharedModule, typeof i4.TooltipModule, typeof i5.Ripple, typeof i6.Scroller, typeof i7.AutoFocusModule, typeof i8.TimesIcon, typeof i8.ChevronDownIcon, typeof i8.SearchIcon, typeof i8.BlankIcon, typeof i8.CheckIcon, typeof i9.InputTextModule, typeof i10.IconField, typeof i11.InputIcon], [typeof Dropdown, typeof i2.OverlayModule, typeof i3.SharedModule, typeof i6.Scroller]>;
